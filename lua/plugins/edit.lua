  ...
  },
  {
    ...
    config = function()
      ...
      mc.addKeymapLayer(function(layerSet)
        ...
        layerSet({ 'n', 'x' }, '<C-S-n>', function() mc.matchSkipCursor(1) end, { desc = 'Match skip cursor below' })
        layerSet({ 'n', 'x' }, '<C-S-p>', function() mc.matchSkipCursor(-1) end, { desc = 'Match skip cursor above' })
      ...
      vim.keymap.set({ 'n', 'v' }, '<C-p>', function() mc.matchAddCursor(-1) end, { desc = 'Match add cursor below' })
