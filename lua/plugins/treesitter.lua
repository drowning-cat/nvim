      ...
      require('nvim-treesitter.configs').setup { ---@diagnostic disable-line: missing-fields
        textobjects = {
          ...
          move = {
            ...
            goto_next_start = {
              [']f'] = { query = { '@function.outer', '@class.outer' }, desc = 'Goto next function or class' },
            ...
            goto_next_end = {
              [']F'] = { query = { '@function.outer', '@class.outer' }, desc = 'Goto next:end function or class' },
            },
            goto_previous_start = {
              ['[f'] = { query = { '@function.outer', '@class.outer' }, desc = 'Goto prev function or class' },
              ['[z'] = { query = '@fold', query_group = 'folds', desc = 'Goto prev fold' },
            },
            goto_previous_end = {
              ['[F'] = { query = { '@function.outer', '@class.outer' }, desc = 'Goto prev:end function or class' },
            },
          },
          lsp_interop = {
            enable = true,
            ...
            peek_definition_code = {
              ['<leader>df'] = { query = { '@function.outer', '@class.outer' }, desc = 'Peek [d]efintion' },
            },
          },
        },
      }
