    ...
    config = function()
      ...
      require('submode').create('WinResize', {
        ...
        default = function(register)
          register('h', resize 'left', { desc = 'Resize left' })
          register('j', resize 'down', { desc = 'Resize down' })
          register('k', resize 'up', { desc = 'Resize up' })
          register('l', resize 'right', { desc = 'Resize right' })
          register('<Left>', resize 'left', { desc = 'Resize left' })
          register('<Down>', resize 'down', { desc = 'Resize down' })
          register('<Up>', resize 'up', { desc = 'Resize up' })
          register('<Right>', resize 'right', { desc = 'Resize right' })
        end,
      })
    end,
  },
