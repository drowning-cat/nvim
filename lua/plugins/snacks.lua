...
table.insert(plugins, {
  ...
  opts = {
    ...
    picker = {
      ...
      layouts = vim.tbl_extend('force', user_layouts, {
        default = user_layouts.better_telescope,
      }),
      sources = {
        explorer = {
          layout = function()
            local sidebar = require('snacks.picker.config.layouts').sidebar
            local input = sidebar.layout[1]
            input.border = 'single'
            return sidebar
          end,
          ...
          win = {
            input = {
              ['<F1>'] = { 'toggle_hidden', mode = { 'i', 'n' } },
              ['<F2>'] = { 'toggle_ignored', mode = { 'i', 'n' } },
            },
            preview = {
              ['<F1>'] = 'toggle_hidden',
              ['<F2>'] = 'toggle_ignored',
