...
table.insert(plugins, {
    ...
    styles = {
      ...
      terminal = {
        ...
        on_win = function(win)
          ...
          if vim.g.terminal_insert or vim.g.terminal_insert == nil then
            vim.cmd.startinsert()
          else
            vim.cmd.stopinsert()
          end
        ...
        on_close = function(win)
          ...
          vim.g.terminal_insert = vim.fn.mode() == 't'
        end,
        wo = {
          winbar = '',
        },
  ...
  keys = {
    ...
    { '<leader>sgP', function() require('plugins.snacks.extra.github').pull_requests() end, desc = '[S]earch [g]it [P]ull Requests' },
