...
-- Configure listchars option
vim.opt.listchars:append {
  eol = '¶',
}
vim.opt.list = false

-- Toggle the visibility of listchars
vim.keymap.set('n', '<leader>tl', function()
  vim.opt.list = not vim.api.nvim_get_option_value('list', {})
end, { desc = '[T]oggle [L]istchars visibility' })
...
require('lazy').setup({
  ...
  'tpope/vim-fugitive', -- Git integration for vim/neovim: staging, committing, browsing history, and more
      ...
      require('gitsigns').setup {
        on_attach = function(buf)
          local map = function(keys, func, desc, mode)
            mode = mode or 'n'
            vim.keymap.set(mode, keys, func, { buffer = buf, desc = 'Gitsigns: ' .. desc })
          end
          map('<leader>tb', require('gitsigns').toggle_current_line_blame, '[T]oggle [B]lame')
          map('<leader>hp', require('gitsigns').preview_hunk, '[H]unk [P]review')
        end,
      }
    end,
  },
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      local complete_or_confirm = function()
        ...
        textobjects = {
          ...
          move = {
            ...
            goto_next_end = {
              ...
              [']A'] = { query = '@parameter.inner', desc = 'Goto next:end [P]arameter' },
              [']I'] = { query = '@conditional.inner', desc = 'Goto next:end [C]onditional' },
            ...
            goto_previous_start = {
              ...
              ['[a'] = { query = '@parameter.inner', desc = 'Goto prev [P]arameter' },
              ['[i'] = { query = '@conditional.inner', desc = 'Goto prev [C]onditional' },
            ...
            goto_previous_end = {
              ...
              ['[A'] = { query = '@parameter.inner', desc = 'Goto prev:end [P]arameter' },
              ['[I'] = { query = '@conditional.inner', desc = 'Goto prev:end [C]onditional' },
            ...
            -- },
            -- goto_previous = {
            --   ['[i'] = { query = '@conditional.outer', desc = 'Goto prev @conditional' },
            -- },
          },
          lsp_interop = {
            enable = false,
